...
goog.html.SafeStyle.sanitizePropertyValueString_ = function(a) {
  ...
  return goog.html.SafeStyle.VALUE_RE_.test(b)
    ? goog.html.SafeStyle.hasBalancedQuotes_(a)
      ? goog.html.SafeStyle.sanitizeUrl_(a)
...
goog.html.SafeStyle.FUNCTIONS_RE_ = RegExp(
  "\\b(hsl|hsla|rgb|rgba|matrix|(rotate|scale|translate)(X|Y|Z|3d)?)\\([-0-9a-z.%, ]+\\)",
  "g"
);
...
goog.dom.safe.setButtonFormAction = function(a, b) {
  ...
  goog.dom.asserts.assertIsHTMLButtonElement(
    a
  ).formAction = goog.html.SafeUrl.unwrap(c);
};
    ...
    : (a.href =
        b instanceof goog.html.TrustedResourceUrl
          ...
          : b instanceof goog.html.SafeUrl
            ...
            : goog.html.SafeUrl.sanitizeAssertUnchanged(
                b
              ).getTypedStringValue());
};
...
Blockly.Touch.isMouseOrTouchEvent = function(a) {
  return (
    ...
    goog.string.startsWith(a.type, "pointer")
  );
};
  ...
  for (var d = [], e = Object.create(null), f = 0, g; (g = c[f]); f++)
    if (!g.isNull()) {
      var h = [g.type, g.blockId, g.workspaceId].join(" "),
        ...
        l = k ? k.event : null;
      k
        ? g.type == Blockly.Events.MOVE && k.index == f - 1
...
Blockly.VariableMap.prototype.createVariable = function(a, b, c) {
  ...
  this.variableMap_[b]
    ? this.variableMap_[b].push(d)
    : (this.variableMap_[b] = [d]);
  return d;
};
...
Blockly.VariableMap.prototype.getVariableTypes = function() {
  for (var a = Object.keys(this.variableMap_), b = !1, c = 0; c < a.length; c++)
    "" == a[c] && (b = !0);
  b || a.push("");
  return a;
};
...
Blockly.VariableMap.prototype.getVariableUsesById = function(a) {
  for (
    var b = [], c = this.workspace.getAllBlocks(), d = 0;
    d < c.length;
    d++
  ) {
...
Blockly.Events.CommentMove.prototype.fromJson = function(a) {
  ...
  a.newCoordinate &&
    ...
    (this.newCoordinate_ = new goog.math.Coordinate(
      parseFloat(a[0]),
      parseFloat(a[1])
    )));
};
...
Blockly.Workspace.prototype.removeTopComment = function(a) {
  if (!goog.array.remove(this.topComments_, a))
...
Blockly.Connection.prototype.setCheck = function(a) {
  a
    ? (goog.isArray(a) || (a = [a]), (this.check_ = a), this.onCheckChanged_())
    : (this.check_ = null);
  return this;
};
...
Blockly.DraggedConnectionManager.prototype.update = function(a, b) {
  ...
  e &&
    this.closestConnection_ &&
    (this.closestConnection_.unhighlight(), (this.closestConnection_ = null));
...
Blockly.DraggedConnectionManager.prototype.updateClosest_ = function(a) {
  ...
  for (var c = 0; c < this.availableConnections_.length; c++) {
    ...
    e.connection &&
      ((this.closestConnection_ = e.connection),
      (this.localConnection_ = d),
      (this.radiusConnection_ = e.radius));
  }
...
Blockly.BlockDragger.prototype.pixelsToWorkspaceUnits_ = function(a) {
  ...
  this.workspace_.isMutator &&
    (a = a.scale(1 / this.workspace_.options.parentWorkspace.scale));
  return a;
};
...
Blockly.WorkspaceCommentSvg.prototype.getBoundingRectangle = function() {
  ...
  if (this.RTL) {
    ...
    (c = new goog.math.Coordinate(a.x, a.y)),
      (a = new goog.math.Coordinate(a.x + b.width, a.y + b.height));
...
Blockly.Tooltip.onMouseOver_ = function(a) {
  if (!Blockly.Tooltip.blocked_) {
    for (
      a = a.target;
      !goog.isString(a.tooltip) && !goog.isFunction(a.tooltip);
...
Blockly.Gesture.prototype.updateDragDelta_ = function(a) {
  ...
  return this.hasExceededDragRadius_
    ...
    : (this.hasExceededDragRadius_ =
        goog.math.Coordinate.magnitude(this.currentDragDeltaXY_) >
...
Blockly.Gesture.prototype.updateIsDraggingFromFlyout_ = function() {
  return this.targetBlock_.disabled
    ? !1
  ...
  Blockly.utils.isTargetInput(a)
    ...
    : ((this.hasStarted_ = !0),
      ...
      Blockly.utils.isRightButton(a)
        ...
        : ((goog.string.caseInsensitiveEquals(a.type, "touchstart") ||
            (goog.string.caseInsensitiveEquals(a.type, "pointerdown") &&
              "mouse" != a.pointerType)) &&
            Blockly.longStart_(a, this),
          (this.mouseDownXY_ = new goog.math.Coordinate(a.clientX, a.clientY)),
...
Blockly.Gesture.prototype.isFieldClick_ = function() {
  return (
    (this.startField_ ? this.startField_.isCurrentlyEditable() : !1) &&
    !this.hasExceededDragRadius_ &&
    (!this.flyout_ || !this.flyout_.autoClose)
  );
};
...
Blockly.utils.removeAttribute = function(a, b) {
  goog.userAgent.IE && goog.userAgent.isVersion("10.0")
    ? a.setAttribute(b, null)
    : a.removeAttribute(b);
};
...
Blockly.utils.removeClass = function(a, b) {
  ...
  c.length
    ...
    : Blockly.utils.removeAttribute(a, "class");
  return !0;
};
              ...
              : "}" != k
                ...
                : ((e = f.join("")),
                  /[a-zA-Z][a-zA-Z0-9_]*/.test(e)
                    ? ((k = e.toUpperCase()),
                      (k = goog.string.startsWith(k, "BKY_")
                        ? k.substring(4)
...
Blockly.Grid.createDom = function(a, b, c) {
  ...
  0 < b.length && 0 < b.spacing
    ? (Blockly.utils.createSvgElement("line", { stroke: b.colour }, a),
      1 < b.length &&
        Blockly.utils.createSvgElement("line", { stroke: b.colour }, a))
    : Blockly.utils.createSvgElement("line", {}, a);
  return a;
};
...
Blockly.TouchGesture.prototype.handleTouchStart = function(a) {
  ...
  2 == b.length &&
    ((this.startDistance_ = goog.math.Coordinate.distance(
  ...
  if (0 < a.length) {
    ...
    if (Blockly.Blocks.variables_set) {
      ...
      d =
        ...
        d +
        '">' +
        Blockly.Variables.generateVariableFieldXmlString(c) +
        "</block></xml>";
      d = Blockly.Xml.textToDom(d).firstChild;
      b.push(d);
    }
    Blockly.Blocks.math_change &&
      ((d = Blockly.Blocks.variables_get ? 20 : 8),
      (d =
    ...
    for (c = 0; (d = a[c]); c++)
      Blockly.Blocks.variables_get &&
        ((d =
          ...
          Blockly.Variables.generateVariableFieldXmlString(d) +
          "</block></xml>"),
        (d = Blockly.Xml.textToDom(d).firstChild),
        b.push(d));
  }
  ...
  if (0 < a.length) {
    if (Blockly.Blocks.variables_set_dynamic) {
      var c =
        ...
        Blockly.Variables.generateVariableFieldXmlString(a[0]) +
        "</block></xml>";
...
Blockly.WorkspaceCommentSvg.prototype.addDeleteDom_ = function() {
  ...
  this.deleteIconBorder_ = Blockly.utils.createSvgElement(
    "circle",
...
Blockly.Xml.workspaceToDom = function(a, b) {
  ...
  c.appendChild(
    Blockly.Xml.variablesToDom(Blockly.Variables.allUsedVarModels(a))
  );
  for (var d = a.getTopComments(!0), e = 0, f; (f = d[e]); e++)
...
Blockly.Xml.blockToDom = function(a, b) {
  ...
  for (var f; (f = a.inputList[e]); e++) {
    ...
    if (f.type != Blockly.DUMMY_INPUT) {
      ...
      f.type == Blockly.INPUT_VALUE
        ? (g = goog.dom.createDom("value"))
        : f.type == Blockly.NEXT_STATEMENT &&
          (g = goog.dom.createDom("statement"));
  ...
  if ((e = a.getNextBlock()))
    (g = goog.dom.createDom("next", null, Blockly.Xml.blockToDom(e, b))),
      c.appendChild(g);
...
Blockly.Xml.domToBlockHeadless_ = function(a, b) {
  ...
  (e = a.getAttribute("disabled")) &&
    c.setDisabled("true" == e || "disabled" == e);
...
Blockly.Xml.domToField_ = function(a, b, c) {
  ...
  d
    ? ((a = a.workspace),
      (b = c.textContent),
      d.referencesVariables()
        ? Blockly.Xml.domToFieldVariable_(a, c, b, d)
        : d.setValue(b))
    ...
    if (!isNaN(c) && !isNaN(d)) {
      ...
      do {
        ...
        if (!a) {
          ...
          for (var l; (l = k[f]); f++)
            if (
              l.closest(Blockly.SNAP_RADIUS, new goog.math.Coordinate(c, d))
                .connection
            ) {
              a = !0;
              break;
...
Blockly.WorkspaceSvg.prototype.isDeleteArea = function(a) {
  ...
  return this.deleteAreaTrash_ && this.deleteAreaTrash_.contains(a)
    ? Blockly.DELETE_AREA_TRASH
    : this.deleteAreaToolbox_ && this.deleteAreaToolbox_.contains(a)
...
Blockly.Field.register = function(a, b) {
  ...
  if (!goog.isObject(b) || !goog.isFunction(b.fromJson))
...
Blockly.Block = function(a, b, c) {
  "undefined" !== typeof Blockly.Generator.prototype[b] &&
    console.warn(
  ...
  b &&
    ((this.type = b),
    (c = Blockly.Blocks[b]),
    goog.asserts.assertObject(c, 'Error: Unknown block type "%s".', b),
    goog.mixin(this, c));
  a.addTopBlock(this);
...
Blockly.Block.prototype.setColour = function(a) {
  ...
  if (!isNaN(c) && 0 <= c && 360 >= c)
    (this.hue_ = c), (this.colour_ = Blockly.hueToRgb(c));
  else if (goog.isString(b) && /^#[0-9a-fA-F]{6}$/.test(b))
    (this.colour_ = b), (this.hue_ = null);
  else
  ...
  if (!this.workspace.options.readOnly && this.contextMenu) {
    ...
    if (this.isDeletable() && this.isMovable() && !b.isInFlyout) {
      ...
      this.isEditable() &&
        ...
        c.push(Blockly.ContextMenu.blockCommentOption(b));
      if (!this.collapsed_)
...
Blockly.FieldTextInput.prototype.showEditor_ = function(a) {
  ...
  a = a || !1;
  !a && (goog.userAgent.MOBILE || goog.userAgent.ANDROID || goog.userAgent.IPAD)
...
Blockly.FieldTextInput.prototype.bindEvents_ = function(a) {
  a.onKeyDownWrapper_ = Blockly.bindEventWithChecks_(
    a,
    "keydown",
    this,
    this.onHtmlInputKeyDown_
  );
  a.onKeyUpWrapper_ = Blockly.bindEventWithChecks_(
    a,
    "keyup",
    this,
    this.onHtmlInputChange_
  );
  a.onKeyPressWrapper_ = Blockly.bindEventWithChecks_(
    a,
    "keypress",
    this,
    this.onHtmlInputChange_
  ...
  if (null !== a && a !== this.value_) {
    ...
    for (var b = this.getOptions(), c = 0; c < b.length; c++)
      if (b[c][1] == a) {
        a = b[c][0];
        "object" == typeof a
          ? ((this.imageJson_ = a), (this.text_ = a.alt))
          : ((this.imageJson_ = null), (this.text_ = a));
        this.forceRerender();
        return;
      }
    this.text_ = a;
...
Blockly.FieldVariable.prototype.init = function() {
  this.fieldGroup_ ||
    (Blockly.FieldVariable.superClass_.init.call(this), this.initModel());
};
...
Blockly.FieldVariable.prototype.setValue = function(a) {
  ...
  var c = b.type;
  if (!this.typeIsAllowed_(c))
    throw Error("Variable type doesn't match this field!  Type was " + c);
  this.sourceBlock_ &&
    Blockly.Events.isEnabled() &&
    ((c = this.variable_ ? this.variable_.getId() : null),
    Blockly.Events.fire(
      new Blockly.Events.BlockChange(
        this.sourceBlock_,
        "field",
...
Blockly.Flyout.prototype.positionAt_ = function(a, b, c, d) {
  ...
  this.scrollbar_ &&
    (this.scrollbar_.setOrigin(c, d), this.scrollbar_.resize());
};
...
Blockly.Flyout.prototype.clearOldBlocks_ = function() {
  ...
  for (b = 0; b < this.mats_.length; b++)
    (a = this.mats_[b]) && goog.dom.removeNode(a);
...
Blockly.HorizontalFlyout.prototype.setMetrics_ = function(a) {
  ...
  b &&
    (goog.isNumber(a.x) && (this.workspace_.scrollX = -b.contentWidth * a.x),
...
Blockly.VerticalFlyout.prototype.setMetrics_ = function(a) {
  var b = this.getMetrics_();
  b &&
    (goog.isNumber(a.y) && (this.workspace_.scrollY = -b.contentHeight * a.y),
    this.workspace_.translate(
      this.workspace_.scrollX + b.absoluteLeft,
      this.workspace_.scrollY + b.absoluteTop
    ));
  ...
  if (this.isVisible()) {
    ...
    if (a) {
      ...
      this.toolboxPosition_ == Blockly.TOOLBOX_AT_RIGHT &&
        (this.leftEdge_ = c += a.viewWidth - this.width_);
...
Blockly.VerticalFlyout.prototype.getClientRect = function() {
  ...
  if (this.toolboxPosition_ == Blockly.TOOLBOX_AT_LEFT)
    return new goog.math.Rect(b - 1e9, -1e9, 1e9 + a, 2e9);
  if (
    goog.userAgent.GECKO &&
    this.targetWorkspace_ &&
      ...
      switch (g.tagName.toUpperCase()) {
        case "CATEGORY":
          ...
          null === k || "" === k
            ? (h.hexColour = "")
            : /^#[0-9a-fA-F]{6}$/.test(k)
              ? ((h.hexColour = k), (this.hasColours_ = !0))
              : "number" === typeof k ||
                ("string" === typeof k && !isNaN(Number(k)))
                ? ((h.hexColour = Blockly.hueToRgb(Number(k))),
                  (this.hasColours_ = !0))
                : ((h.hexColour = ""),
                  console.warn(
                    'Toolbox category "' +
      ...
      Blockly.selected &&
        ...
        (67 == a.keyCode
          ...
          : 88 != a.keyCode ||
            ...
            (Blockly.copy_(Blockly.selected), (b = !0)));
      86 == a.keyCode
...
Blockly.bindEvent_ = function(a, b, c, d) {
  ...
  if (g && g.PointerEvent && b in Blockly.Touch.TOUCH_MAP) {
    g = 0;
    for (var h; (h = Blockly.Touch.TOUCH_MAP[b][g]); g++)
