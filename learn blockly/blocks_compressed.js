...
Blockly.Constants.Logic.LOGIC_COMPARE_ONCHANGE_MIXIN = {
  onchange: function(a) {
    ...
    b &&
      c &&
      !b.outputConnection.checkType_(c.outputConnection) &&
  ...
  onchange: function(a) {
    ...
    if ((b || c) && d)
      for (var e = 0; 2 > e; e++) {
        var f = 1 == e ? b : c;
        f &&
          !f.outputConnection.checkType_(d) &&
          (Blockly.Events.setGroup(a.group),
...
Blockly.Blocks.procedures_defnoreturn = {
  ...
  domToMutation: function(a) {
    ...
    for (var b = 0, c; (c = a.childNodes[b]); b++)
      if ("arg" == c.nodeName.toLowerCase()) {
        ...
        d = Blockly.Variables.getOrCreateVariablePackage(
          this.workspace,
          c,
          d,
          ""
  ...
  renameVarById: function(a, b) {
    ...
    if ("" == c.type) {
      c = c.name;
      for (
        var d = this.workspace.getVariableById(b), e = !1, f = 0;
        f < this.argumentVarModels_.length;
        f++
      )
        this.argumentVarModels_[f].getId() == a &&
          ((this.arguments_[f] = d.name),
          (this.argumentVarModels_[f] = d),
          (e = !0));
  ...
  customContextMenu: function(a) {
    if (!this.isInFlyout) {
      ...
      a.push(b);
      if (!this.isCollapsed())
        for (e = 0; e < this.argumentVarModels_.length; e++)
          (b = { enabled: !0 }),
            (d = this.argumentVarModels_[e]),
            (c = d.name),
            (b.text = Blockly.Msg.VARIABLES_SET_CREATE_GET.replace("%1", c)),
            (c = Blockly.Variables.generateVariableFieldDom(d)),
    ...
    if (b)
      if (goog.array.equals(this.arguments_, a)) this.quarkIds_ = b;
        ...
        if ((this.quarkIds_ = b))
          for (e = 0; e < this.arguments_.length; e++)
            (d = this.quarkIds_[e]),
              d in this.quarkConnections_ &&
                ((f = this.quarkConnections_[d]),
                Blockly.Mutator.reconnect(f, this, "ARG" + e) ||
                  delete this.quarkConnections_[d]);
...
Blockly.Constants.Text.QUOTE_IMAGE_MIXIN = {
  ...
  newQuote_: function(a) {
    ...
    return new Blockly.FieldImage(
      a ? this.QUOTE_IMAGE_LEFT_DATAURI : this.QUOTE_IMAGE_RIGHT_DATAURI,
...
Blockly.Constants.Text.TEXT_CHARAT_EXTENSION = function() {
  ...
  this.setTooltip(function() {
    ...
    ("FROM_START" == b || "FROM_END" == b) &&
      ...
      (c +=
        "  " +
        b.replace("%1", a.workspace.options.oneBasedIndex ? "#1" : "#0"));
    return c;
  });
};
Blockly.Extensions.register(
